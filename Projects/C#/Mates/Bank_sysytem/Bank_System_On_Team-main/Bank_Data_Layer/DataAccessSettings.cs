...
namespace Bank_Data_Layer
{
    public class clsDataAccessSettings
    {
        ...
        //private static string _ConnectionString = "server=.; DataBase= BankSystem; User Id = sa; Password=sa123456";
        private static string _ConnectionString = "Data source=.;initial catalog=BankSystem;Integrated security = true;";
